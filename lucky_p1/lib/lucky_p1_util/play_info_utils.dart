...
class PlayInfoUtils extends LuckyBaseSql{
  ...
  Future<List<PlayInfoBean>> queryPlayList()async{
    ...
    if(list.isEmpty){
      var initList=[
        PlayInfoBean(type: PlayType.card1.name,playedNum: 0,unlock: 1,time: 0),
        PlayInfoBean(type: PlayType.card2.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card3.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card4.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card5.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card6.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card7.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card8.name,playedNum: 0,unlock: 0,time: 0),
        PlayInfoBean(type: PlayType.card9.name,playedNum: 0,unlock: 0,time: 0),
      ];
  ...
  unlockPlayType(PlayType playType)async{
    var sql = await initSql();

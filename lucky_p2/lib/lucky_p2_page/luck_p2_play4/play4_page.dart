...
class Play4Page extends LuckyBasePage2<Play4Controller>{
  @override
      ...
      child: Stack(
        children: [
          Scratcher(
            ...
            image: Image.asset('lucky_images/play413.webp',fit: BoxFit.fill,),
            onThreshold: (){
            ...
            child: Stack(
              ...
              children: [
                LuckyImageWidget(name: "play414",width: double.infinity,height: double.infinity,),

...
class Play3Page extends LuckyBasePage2<Play3Controller>{
  @override
      ...
      child: Stack(
        children: [
          Scratcher(
            ...
            image: Image.asset('lucky_images/play34.webp',fit: BoxFit.fill,),
            onThreshold: (){
            ...
            child: Stack(
              ...
              children: [
                LuckyImageWidget(name: "play35",width: double.infinity,height: double.infinity,),
          ...
          Align(
            ...
            child: MaxNumWidget(playType: luckyController.playUtils.playType, fontSize: 30.sp).marginOnly(top: 20.h),
          ),
        ],
      ),
    ),

...
class Play7Page extends LuckyBasePage2<Play7Controller>{
  @override
      ...
      child: Stack(
        children: [
          Scratcher(
            ...
            image: Image.asset('lucky_images/play78.webp',fit: BoxFit.fill,),
            onThreshold: (){
            ...
            child: Stack(
              ...
              children: [
                LuckyImageWidget(name: "play79",width: double.infinity,height: double.infinity,),

...
class WheelWinController extends LuckyBaseController{
  ...
  void onInit() {
    super.onInit();
    TTTTUtils.instance.pointEvent(customId: CustomId.wheel_reward_pop);
  }

  clickDouble(double allReward,Function(double addNum) dismiss){
    TTTTUtils.instance.pointEvent(customId: CustomId.wheel_reward_pop_c);
  ...
  clickSingle(double allReward,Function(double addNum) dismiss){
    TTTTUtils.instance.pointEvent(customId: CustomId.wheel_reward_pop_c_single);
    LuckyAdUtils.instance.showP2Ad(
